...
float AnimatedCircleToAnimatedAABB(const Vector3D& Start0, const Vector3D& End0, const float Radius0, const Vector3D& Start1, const Vector3D& End1, const float Radius1, Vector3D& Pi);
